...
class ThirdPInv : public User {
    ...
    public:
        ...
        ThirdPInv(string u, string p, string c, string id) : User(u, p, c), thirdPInvID(id) {}
        ...
        */
        bool generateThirdPReport(int extinguisherId, int assignmentId, string inspectionDate, string notes)
        {
            ...
            cout << "Third-party report generated: " << "Ext #" << extinguisherId << ", Assignment #" << assignmentId << ", Date: " << inspectionDate << "." << endl;
